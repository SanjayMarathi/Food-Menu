...
# Import the custom Order model (self-referencing import)
...
class Order(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True) # Can be null if QR scan is used without login
    table_number = models.CharField(max_length=10, null=True, blank=True) # For QR scan flow
...
class OrderItem(models.Model):
    ...
    item = models.ForeignKey(Item, on_delete=models.SET_NULL, null=True) # Item can be deleted after order is placed
    item_name = models.CharField(max_length=100) # Store name at time of order
    item_price = models.DecimalField(max_digits=6, decimal_places=2) # Store price at time of order
